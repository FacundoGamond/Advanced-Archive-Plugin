...
class Debounce {
  ...
  init() {
    ...
    const $input = this.input; //on keyup, start the countdown
...
/* harmony import */ var _utils_debounce__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/debounce */ "./assets/js/utils/debounce.js");
...
class AdvancedPagination {
    ...
    this.taxonomiesBoxes.forEach(taxonomy => {
      ...
      taxonomyTerms.forEach(term => {
        term.addEventListener('click', () => {
          //Close dropdown
          dropdown.classList.toggle('open'); //Change current filter
  ...
  searchPosts() {
    if (this.searchInput) {
      new _utils_debounce__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  call(reloadController = false) {
    ...
    this.loader();
    this.pageNumbersLimiter();
    _utils_api__WEBPACK_IMPORTED_MODULE_0__["default"].get('post-powers/v1/paged-posts', {
      params: {
...
/******/ })()
;
//# sourceMappingURL=advanced-archive.min.js.map